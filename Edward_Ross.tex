...
\startExp{Connexity}{Nov 2014--Present}{Data Engineer}
\exp{Implemented scores of bespoke reports for clients using Python, PostgeSQL, and Hadoop}
\exp{Developed and documented tools that increased throughput by 30\%}
% Hourly Data, Bounce Rate, Seek Scraping, Amazon, Daily Mail from Facebook
\exp{Developed and implemented five new products using Python, Pig, and Hadoop Mapreduce}
% Justin, Josh, Brice, Mike, Luan
\exp{Documented methodology and tools, and trained five new staff}
\exp{Discovered and helped resolve data anomolies and implementation errors}
...
\skill{Linux}
\exp{Automated processes using shell scripts}
\exp{Experienced with tools such as grep, sed, find}
\exp{Installed and administrated personal workstations}

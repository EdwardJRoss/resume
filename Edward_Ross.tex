...
\def\markupLink#1#2{\href{#2}{\textcolor{blue}{#1}}}
...
\expContent
SEEK is a leading digital jobs marketplace in 14 countries across Asia and South America. \par
Worked in a team of Product Managers, Engineers, and Data Scientists to design customer-facing machine learning based services and metrics, write and maintain data and model training pipelines, and to work with internal stakeholders to communicate, debug, and improve models.
\skilljump
\exp{Led development of an embedding-based retrieval system that outperformed existing IR based solution}
\exp{Fine-tuned BERT based models for classification of documents to replace existing CNN sytem}
\exp{Created clusters of similar roles using community detection to improve marketplace reporting}
\exp{Trained FastText models to classify job titles across multiple markets}
\exp{Implemented production system to detect duplicate job ads at scale using MinHash}
\exp{Worked with Commercial Strategy to design and implement data driven pricing system}
\exp{Designed and analysed experiment to help users improve their ads}
%\exp{Improved bespoke decision tree regression solution to estimate job salary}
% Career graph
...
Carsales.com is the largest online automotive classified business in Australia. \par
...
\exp{Used HyperLogLog in BigQuery enabling Ad Operations and Media Sales teams to self-serve campaign reports in a flexible and efficient way.}
\exp{Built Python pipeline to extract trends from relevant economic indicators impacting the business}
\exp{Created customer segments in R using K-medoids clustering of survey data for marketing materials}

\endExp

\startExp{Hitwise}{Nov 2014--Sep 2017}{Data Engineer}
Hitwise was a competitive intelligence service providing insights to marketers on how consumers act online. \par
...
Haese Mathematics is a family-owned publishing company specialising in Mathematics textbooks and accompanying software. \par
In the software development team I created interactive demonstrations for students and automated test generators for teachers.
\skilljump

%\exp{Developed and maintained Java applications to enrich student learning and help teachers}
...
Implemented stochastic simulations of complex networks in MATLAB.

...
Initially worked as an analyst in a cross-functional team building insights products, before becoming the Data Science Lead for Pricing working with Data Scientists, Engineers and an AI Product Manager.
%In the Analytics team I worked with product teams to improve their products using data driven insights.
\skilljump
\exp{Worked with Commercial Strategy to design and implement value based pricing of ad products}
\exp{Created clusters of similar roles using community detection to improve marketplace reporting}
\exp{Maintained and operated pipeline for calculating the value of roles and assigning prices}

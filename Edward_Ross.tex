...
\startExp{Hitwise}{Nov 2014--Present}{Data Modeller/Engineer}
...
\exp{Performed analyses and provided visualisations using R and Tableau}
...
\exp{Implemented and analysed stochastic simulations of complex networks in MATLAB}
...
\skilljump
%% MORE
\exp{Developed and communicated technical solutions with clients and analysts at Hitwise}
...
\skill{Analysing and Presenting Data}
 I have experience producing numerical simulations, statistically analysing data and presenting results.

\skilljump
\exp{Reported on integrity and bias of data sources to management at Hitwise}
\exp{Won HealthHack 2016 on team Morgana developing data visualisation using Python and d3.js}
\exp{Produced data visualisations using ggplot, maplotlib and Tableau}
...
\exp{Extracted and transformed data from HDFS, Greenplum, Excel, REST APIs, HTML and Javascript}
\exp{Cleaned, assessed and integrated supplementary data sources}
\exp{Designed and implemented ETL pipelines into PostgreSQL databases backing web interfaces}

...
\expContent
SEEK is a leading digital jobs marketplace in 14 countries across Asia and South America.
I am working as Data Science Lead for Pricing in a cross-functional team from formulating data driven solutions to commercial problems, to building production machine learning pipelines through to testing and communicating results of changes to stakeholders.
\skilljump
\exp{Worked with Commercial Strategy to design and implement data driven pricing of ad products}
...
\exp{Trained production FastText models to classify job titles across 6 countries}
...
Hitwise was a competitive intelligence service providing insights to marketers on how consumers act online.
